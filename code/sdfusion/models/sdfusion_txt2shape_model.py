...
class SDFusionText2ShapeModel(BaseModel):
    ...
    def train(self, data, ddim_steps=None, ddim_eta=0., uc_scale=None, txt_scale = 1.0):
    ...
    @torch.no_grad()
    def inference(self, data, ddim_steps=None, ddim_eta=0., uc_scale=None, txt_scale = 1.0):
