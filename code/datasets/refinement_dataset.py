...
class RefinementDataset(torch.utils.data.Dataset):
    ...
    def __init__(self,
        ...
        print(data_dir,img_res,scan_id,center_crop_type,use_mask,num_views)
    ...
    def __getitem__(self, idx):
        ...
        random_idx = random.randint(0,len(self.obj_ids)-1)

        pseudo = {
            "object_id" : self.obj_ids[random_idx],
            "object" : self.objs[random_idx],
            "bbox" : self.bboxes[random_idx]
        }
        ...
        return idx, sample, ground_truth, pseudo
